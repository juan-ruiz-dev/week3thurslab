...
sayHelloButton.addEventListener('mouseout', colorReverse)
...
queryRequest = () => {
    axios.get('http://localhost:3000/query-test?hello=2')
    .then((res) => {
...
/*
    ...
    // Just adds the second query to the value of the first query
*/
